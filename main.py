...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://graph.org/file/e5a63353f26444d2e20ac-55d976397b2ffcf0d0.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/nofraction")],
        ])
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/e5a63353f26444d2e20ac-55d976397b2ffcf0d0.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def upgrade_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/c31ffe4a039c8b4607777-2645b2e8b3b2477b71.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def pin_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/828b99a5e373ad22b7539-ddebc500307f89f254.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
...
async def custom_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/c107b8f258ac20b398b5b-086481a22579b496a9.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
